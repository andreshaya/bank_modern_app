...
const Hero = () => (
    ...
    className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        relative z-[5]'/>
        <div className='absolute z-[0] w-[40%] h-[25%] top-20 pink__gradient' />
        <div className='absolute z-[1] w-[60%] h-[60%] bottom-40 rounded-full
         white__gradient' />
         <div className='absolute z-[0] w-[40%] h-[40%] right-20 bottom-20
          blue__gradient' />
      </div>
